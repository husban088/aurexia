...
export default function CouponsPanel() {
  ...
  return (
    <div className="coupons-panel-container">
      ...
      <div className="coupons-panel-card">
        ...
        <div className="info-note">
          ...
          <div className="info-text">
            ...
            <br />
            • Disabled coupons will show "not active" message when customers try
            to use them
            <br />
            • Changes apply immediately for all users
            <br />• Customers enter codes exactly as shown: DISC4U10 or DISC4U20
          </div>
        </div>
      </div>
    </div>
